...
if __name__ == "__main__":
    ...
    while True:
        ...
        print(f"episode {i} total reward: {game.get_total_reward()} loss: {loss: .4f}")
        opt.zero_grad()
        loss.backward()
        opt.step()
        ...
        out_f.flush()
        if i % 10000 == 0:
            torch.save(model, f'/home/krjeo/PycharmProjects/pythonProject/trained_models/{i}th_trained_model.pt')
